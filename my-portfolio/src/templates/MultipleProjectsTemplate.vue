<template>
  <headline-and-gallary-layout>
    ...
    <project-card slot="displayItem" v-for="(project, index) in projects" :key=index :project="project" />
...
import HeadlineAndGallaryLayout from "@/layouts/HeadlineAndGallaryLayout";
